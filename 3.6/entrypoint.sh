...
# docker run --name some-postgres -e POSTGRES_PASSWORD=mysecretpassword -e POSTGRES_DB=airflow -d -p 5433:5433 postgres:13
# docker run --name some-postgres -e POSTGRES_PASSWORD=mysecretpassword -e POSTGRES_DB=airflow -d -p 5434:5434 -p 5434:5432/tcp postgres:13
